...
namespace harjutus2_topolja
{
    class Tootaja : Isik
    {
        ...
        public string amet;
        public Tootaja(string asutus, string amet, string nimi, int synniaasta, sugu Sugu, double maksuvaba, double palk, double tulumaks) : base(nimi, synniaasta, Sugu, maksuvaba, palk, tulumaks)
        {
            this.asutus = asutus;
            this.amet = amet;
        }
