...
namespace harjutus2_topolja
{
    class Opilane : Isik
    {
        ...
        public Opilane(string koolinimi, string klass, string spetsialiseerumine, string nimi, int synniaasta, sugu Sugu, double maksuvaba, double palk, double tulumaks) : base(nimi, synniaasta, Sugu, maksuvaba, palk, tulumaks)
        {
