...
namespace harjutus2_topolja
{
    class Kutsekooliopilane : Isik
    {
        ...
        public Kutsekooliopilane(double toetussumma, string elamiskoht, double perepalk, int lastearv, double keskhinne, string oppeasutus, string eriala, string kursus, string nimi, int synniaasta, sugu Sugu, double maksuvaba, double palk, double tulumaks) : base(nimi, synniaasta, Sugu, maksuvaba, palk, tulumaks)
        {
